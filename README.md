...
Fichiers de déploiement : `vercel.json`, `app.py`, `runtime.txt`, `pyproject.toml` (`tool.vercel.entrypoint = "app:app"`). Ne pas utiliser `builds` ni `functions.api/index.py` (obsolète avec le preset Flask).
